  ...
  extends PHPUnit_Framework_TestCase
{
   ...
   */
  public function getStubStrict($originalClassName, $stubedMethods, $arguments = array(), $mockClassName = '', $callOriginalConstructor = true, $callOriginalClone = true, $callAutoload = true)
  {
    return $this->getStub(
      $originalClassName, 
      $stubedMethods, 
  ...
  public function getStub($originalClassName, $stubedMethods, $arguments = array(), $mockClassName = '', $callOriginalConstructor = true, $callOriginalClone = true, $callAutoload = true, $strict = false)
  {
