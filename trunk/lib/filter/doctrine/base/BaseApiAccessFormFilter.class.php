...
/**
 * ApiAccess filter form base class.
 *
 * @package    dockeet
 * @subpackage filter
 ...
 */
abstract class BaseApiAccessFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('api_access_filters[%s]');
